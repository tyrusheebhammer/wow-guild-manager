package com.sonnebtb.wowguildmanager.battlenet_oauth2;
...
public class BnConstants {
    ...
    public static final String BUNDLE_REDIRECT_ACTIVITY = "BUNDLE_REDIRECT_ACTIVITY";
    public static final String BUNDLE_BNPARAMS = "BUNDLE_BNPARAMS";
}
